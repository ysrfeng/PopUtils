...
/**
 * Created by ysr on 2017/3/10 下午5:31.
...
//            Log.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#181818"));
               // itemView.setTypeface(Typeface.SANS_SERIF,Typeface.BOLD);
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#727373"));
            paint.setStrokeWidth(dip2px(1f));
        }

        background = new Drawable() {
            @Override
            public void draw(Canvas canvas) {//起点0 终点1
